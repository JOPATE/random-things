...
execute if score timer bad_effects_cooldown = f pf_timer run item replace entity @a[nbt={ SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Lore:['{"text": "can be used to make magic","italic": false}']}}},Inventory:[{Slot:-106b,id:"minecraft:paper",tag:{display:{Name:'{ "text": "Bad Effects Scroll","italic": false, "color": "dark_gray"}'},CustomModelData:402014}}]}] weapon.mainhand with carrot_on_a_stick{CustomModelData:402017,display:{Lore:['{"text": "can be used to make magic","italic": false}'],Name:'{ "text": "Wand Selected: Bad Effects","color": "dark_gray","italic": false}'},Enchantments:[{id:"minecraft:unbreaking",lvl:100}],HideFlags:1}
execute if score timer bad_effects_cooldown > f pf_timer run item replace entity @a[nbt={ SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Lore:['{"text": "can be used to make magic","italic": false}']}}},Inventory:[{Slot:-106b,id:"minecraft:paper",tag:{display:{Name:'{ "text": "Bad Effects Scroll","italic": false, "color": "dark_gray"}'},CustomModelData:402014}}]}] weapon.mainhand with carrot_on_a_stick{CustomModelData:402011,display:{Lore:['{"text": "can be used to make magic","italic": false}'],Name:'{ "text": "Wand Selected: Bad Effects","color": "dark_red","italic": false}'},Enchantments:[{id:"minecraft:unbreaking",lvl:100}],HideFlags:1}
execute if score timer mob_stop_cooldown > f pf_timer run scoreboard players remove timer mob_stop_cooldown 1
execute if score timer mob_stop_cooldown = f pf_timer run item replace entity @a[nbt={ SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Lore:['{"text": "can be used to make magic","italic": false}']}}},Inventory:[{Slot:-106b,id:"minecraft:paper",tag:{display:{Name:'{ "text": "Mob Stop Scroll","italic": false, "color": "dark_blue"}'},CustomModelData:402014}}]}] weapon.mainhand with carrot_on_a_stick{CustomModelData:402010,display:{Lore:['{"text": "can be used to make magic","italic": false}'],Name:'{ "text": "Wand Selected: Mob Stop","color": "dark_blue","italic": false}'},Enchantments:[{id:"minecraft:unbreaking",lvl:100}],HideFlags:1}
execute if score timer mob_stop_cooldown > f pf_timer run item replace entity @a[nbt={ SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Lore:['{"text": "can be used to make magic","italic": false}']}}},Inventory:[{Slot:-106b,id:"minecraft:paper",tag:{display:{Name:'{ "text": "Mob Stop Scroll","italic": false, "color": "dark_blue"}'},CustomModelData:402014}}]}] weapon.mainhand with carrot_on_a_stick{CustomModelData:402011,display:{Lore:['{"text": "can be used to make magic","italic": false}'],Name:'{ "text": "Wand Selected: Mob Stop","color": "dark_red","italic": false}'},Enchantments:[{id:"minecraft:unbreaking",lvl:100}],HideFlags:1}
#right click
execute if score timer mob_stop_cooldown = f pf_timer as @a[scores={right_click=1},nbt={ SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Lore:['{"text": "can be used to make magic","italic": false}']}}},Inventory:[{id:"minecraft:emerald",tag:{CustomModelData:402015}},{Slot:-106b,id:"minecraft:paper",tag:{display:{Name:'{ "text": "Mob Stop Scroll","italic": false, "color": "dark_blue"}'},CustomModelData:402014}}]}] at @s run function random-things:mob_stop
execute if score timer bad_effects_cooldown = f pf_timer as @a[scores={right_click=1},nbt={ SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Lore:['{"text": "can be used to make magic","italic": false}']}}},Inventory:[{id:"minecraft:emerald",tag:{CustomModelData:402013}},{Slot:-106b,id:"minecraft:paper",tag:{display:{Name:'{ "text": "Bad Effects Scroll","italic": false, "color": "dark_gray"}'},CustomModelData:402014}}]}] at @s run function random-things:bad_effects
