...
execute as @a[nbt={SelectedItem:{id:"minecraft:stick",Count:65b},playerGameType:1}] at @s run function random-things:stick
execute as @a[nbt=!{SelectedItem:{id:"minecraft:stick",Count:65b},playerGameType:1},team=adm] at @s run function random-things:adm_remove
...
#right-click_jet-pack
execute as @a[scores={jet-pack_right-click=1},nbt={SelectedItem:{id:"minecraft:ender_eye",tag:{CustomModelData:402040}},Inventory:[{Slot:102b,id:"minecraft:elytra",tag:{display:{Name:'{"text": "Jet-Pack","color": "white","italic": false}'},HideFlags:1}},{id:"minecraft:coal"}]},nbt=!{Inventory:[{Slot:102b,id:"minecraft:elytra",tag:{Damage:431}}]}] run function random-things:jet-pack
execute as @a[scores={jet-pack_right-click=0},nbt={SelectedItem:{id:"minecraft:ender_eye",tag:{CustomModelData:402040}},Inventory:[{Slot:102b,id:"minecraft:elytra",tag:{display:{Name:'{"text": "Jet-Pack","color": "white","italic": false}'},HideFlags:1}},{id:"minecraft:coal"}]},nbt=!{Inventory:[{Slot:102b,id:"minecraft:elytra",tag:{Damage:431}}]}] run function random-things:jet-pack2
execute as @a[scores={jet-pack_right-click=0},nbt={SelectedItem:{id:"minecraft:firework_rocket",tag:{CustomModelData:402041}},Inventory:[{Slot:102b,id:"minecraft:elytra",tag:{display:{Name:'{"text": "Jet-Pack","color": "white","italic": false}'},HideFlags:1}},{id:"minecraft:coal"}]},nbt=!{Inventory:[{Slot:102b,id:"minecraft:elytra",tag:{Damage:431}}]}] run function random-things:jet-pack2
execute as @a[scores={jet-pack_right-click=0},nbt={SelectedItem:{id:"minecraft:stick",tag:{CustomModelData:402042}},Inventory:[{Slot:102b,id:"minecraft:elytra",tag:{display:{Name:'{"text": "Jet-Pack","color": "white","italic": false}'},HideFlags:1}},{id:"minecraft:coal"}]},nbt=!{Inventory:[{Slot:102b,id:"minecraft:elytra",tag:{Damage:431}}]}] run function random-things:jet-pack2
scoreboard players set @a jet-pack_right-click 0
execute as @a[nbt={SelectedItem:{id:"minecraft:firework_rocket",tag:{CustomModelData:402041}}},nbt=!{Inventory:[{id:"minecraft:coal"}]}] run item replace entity @s weapon.mainhand with stick{CustomModelData:402042,display:{Name:'{"text":"Jet-Pack Button Mode: ","color": "gray","italic": false, "extra":[{ "text": "NO FUEL","color": "dark_red"}]}'}} 1
execute as @a[nbt={SelectedItem:{id:"minecraft:ender_eye",tag:{CustomModelData:402040}}},nbt=!{Inventory:[{id:"minecraft:coal"}]}] run item replace entity @s weapon.mainhand with stick{CustomModelData:402042,display:{Name:'{"text":"Jet-Pack Button Mode: ","color": "gray","italic": false, "extra":[{ "text": "NO FUEL","color": "dark_red"}]}'}} 1
execute as @a[scores={jet-pack_fuel=0}] run clear @s coal 1
execute as @a if score @s jet-pack_fuel <= f pf_timer run scoreboard players set @s jet-pack_fuel 150
#right-click
