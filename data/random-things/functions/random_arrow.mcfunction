...
execute as @e[tag=boom] at @s run particle explosion ~ ~ ~
execute as @e[tag=boom] at @s run particle flash ~ ~ ~
execute as @e[tag=boom] at @s if score s boom_randomizer = 4 boom_randomizer run particle soul ~ ~ ~
execute as @e[tag=boom] at @s if score s boom_randomizer = 3 boom_randomizer run particle glow ~ ~ ~
execute as @e[tag=boom] at @s if score s boom_randomizer = 2 boom_randomizer run particle note ~ ~ ~
execute as @e[tag=boom] at @s if score s boom_randomizer = 1 boom_randomizer run particle heart ~ ~ ~