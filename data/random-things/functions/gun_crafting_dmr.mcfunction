...
execute as @e[tag=dmr_craft] at @s run give @p minecraft:crossbow{Enchantments:[{id:"minecraft:piercing",lvl:20}],Unbreakable:1b,display:{Name:'{"text":"DMR","italic":false}'}}
